...
class VAE(keras.Model):
    def __init__(self, encoder, decoder, **kwargs):
        ...
        self.reconstruction_loss_tracker = keras.metrics.Mean(name="reconssturction_loss")
    ...
    def train_step(self, data):
        with tf.GradientTape() as tape:
            ...
            return {
                ...
                "reconstrution_loss": self.reconstruction_loss_tracker.result(),
...
def plot_latent_space(vae, n= 10, fig_size=5):
    img_size = 28
    scale = 0.5
